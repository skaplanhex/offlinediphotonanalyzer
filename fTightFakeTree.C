#define fTightFakeTree_cxx
#include "fTightFakeTree.h"
...
void fTightFakeTree::Loop()
{
//   In a ROOT session, you can do:
//      root> .L fTightFakeTree.C
//      root> fTightFakeTree t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    TFile* outfile = new TFile("basicfaketree_tightfake.root","recreate");
    outfile->cd();
    tree->Write();
    outfile->Close();
}
