#define fFakeFakeTree_cxx
#include "fFakeFakeTree.h"
...
void fFakeFakeTree::Loop()
{
//   In a ROOT session, you can do:
//      root> .L fFakeFakeTree.C
//      root> fFakeFakeTree t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    TFile* outfile = new TFile("basicfaketree_fakefake.root","recreate");
    outfile->cd();
    tree->Write();
    outfile->Close();
}
