...
// Thu Mar  2 10:29:42 2017 by ROOT version 6.02/13
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fTree2016(TTree *tree=0);
   virtual ~fTree2016();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString outfilename, bool isMC=false);
...
#ifdef fTree2016_cxx
fTree2016::fTree2016(TTree *tree) : fChain(0) 
{
...
Int_t fTree2016::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fTree2016::LoadTree(Long64_t entry)
{
...
void fTree2016::Init(TTree *tree)
{
...
void fTree2016::Show(Long64_t entry)
{
...
Int_t fTree2016::Cut(Long64_t entry)
{
