...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    leadingPhoPt_VBFTagged_EBEB->Sumw2();
    subleadingPhoPt_VBFTagged_EBEB->Sumw2();
    leadingPhoEta_VBFTagged_EBEB->Sumw2();
    subleadingPhoEta_VBFTagged_EBEB->Sumw2();
    leadingPhoPhi_VBFTagged_EBEB->Sumw2();
    subleadingPhoPhi_VBFTagged_EBEB->Sumw2();
    ggMass_VBFTagged_EBEB->Sumw2();
    leadingPhoPt_VBFTagged_EBEE->Sumw2();
    subleadingPhoPt_VBFTagged_EBEE->Sumw2();
    leadingPhoEta_VBFTagged_EBEE->Sumw2();
    subleadingPhoEta_VBFTagged_EBEE->Sumw2();
    leadingPhoPhi_VBFTagged_EBEE->Sumw2();
    subleadingPhoPhi_VBFTagged_EBEE->Sumw2();
    ggMass_VBFTagged_EBEE->Sumw2();
    nJets_EBEB->Sumw2();
    leadingjetPt_EBEB->Sumw2();
    leadingjetEta_EBEB->Sumw2();
    leadingjetPhi_EBEB->Sumw2();
    leadingjetET_EBEB->Sumw2();
    leadingjetMass_EBEB->Sumw2();
    nJets_EBEE->Sumw2();
    leadingjetPt_EBEE->Sumw2();
    leadingjetEta_EBEE->Sumw2();
    leadingjetPhi_EBEE->Sumw2();
    leadingjetET_EBEE->Sumw2();
    leadingjetMass_EBEE->Sumw2();
    subleadingjetPt_EBEB->Sumw2();
    subleadingjetEta_EBEB->Sumw2();
    subleadingjetPhi_EBEB->Sumw2();
    subleadingjetET_EBEB->Sumw2();
    subleadingjetMass_EBEB->Sumw2();
    subleadingjetPt_EBEE->Sumw2();
    subleadingjetEta_EBEE->Sumw2();
    subleadingjetPhi_EBEE->Sumw2();
    subleadingjetET_EBEE->Sumw2();
    subleadingjetMass_EBEE->Sumw2();
    jetDEta_EBEB->Sumw2();
    dijetMass_EBEB->Sumw2();
    jetPhoEtaDiff_EBEB->Sumw2();
    jetPhoDPhi_EBEB->Sumw2();
    jetDEta_EBEE->Sumw2();
    dijetMass_EBEE->Sumw2();
    jetPhoEtaDiff_EBEE->Sumw2();
    jetPhoDPhi_EBEE->Sumw2();
    nConversions_allConvType_EB->Sumw2();
    nConversions_allConvType_EE->Sumw2();
    nConversions_allConvType_allEta->Sumw2();
    nConversions_arbitratedMerged_EB->Sumw2();
    nConversions_arbitratedMerged_EE->Sumw2();
    nConversions_arbitratedMerged_allEta->Sumw2();
    nConversions_highPurity_EB->Sumw2();
    nConversions_highPurity_EE->Sumw2();
    nConversions_highPurity_allEta->Sumw2();
    nConversions_generalTracksOnly_EB->Sumw2();
    nConversions_generalTracksOnly_EE->Sumw2();
    nConversions_generalTracksOnly_allEta->Sumw2();
    // conversionRadius_allConvType_EB->Sumw2();
    // conversionRadius_allConvType_EE->Sumw2();
    // conversionRadius_allConvType_allEta->Sumw2();
    // conversionRadius_arbitratedMerged_EB->Sumw2();
    // conversionRadius_arbitratedMerged_EE->Sumw2();
    // conversionRadius_arbitratedMerged_allEta->Sumw2();
    // conversionRadius_highPurity_EB->Sumw2();
    // conversionRadius_highPurity_EE->Sumw2();
    // conversionRadius_highPurity_allEta->Sumw2();
    // conversionRadius_generalTracksOnly_EB->Sumw2();
    // conversionRadius_generalTracksOnly_EE->Sumw2();
    // conversionRadius_generalTracksOnly_allEta->Sumw2();
    // twoProngConversionXYMap_allConvType_EB->Sumw2();
    // twoProngConversionRZMap_allConvType_EB->Sumw2();
    // twoProngConversionXYMap_allConvType_EE->Sumw2();
    // twoProngConversionRZMap_allConvType_EE->Sumw2();
    // twoProngConversionXYMap_allConvType_allEta->Sumw2();
    // twoProngConversionRZMap_allConvType_allEta->Sumw2();
    // twoProngConversionXYMap_arbitratedMerged_EB->Sumw2();
    // twoProngConversionRZMap_arbitratedMerged_EB->Sumw2();
    // twoProngConversionXYMap_arbitratedMerged_EE->Sumw2();
    // twoProngConversionRZMap_arbitratedMerged_EE->Sumw2();
    // twoProngConversionXYMap_arbitratedMerged_allEta->Sumw2();
    // twoProngConversionRZMap_arbitratedMerged_allEta->Sumw2();
    // twoProngConversionXYMap_highPurity_EB->Sumw2();
    // twoProngConversionRZMap_highPurity_EB->Sumw2();
    // twoProngConversionXYMap_highPurity_EE->Sumw2();
    // twoProngConversionRZMap_highPurity_EE->Sumw2();
    // twoProngConversionXYMap_highPurity_allEta->Sumw2();
    // twoProngConversionRZMap_highPurity_allEta->Sumw2();
    // twoProngConversionXYMap_generalTracksOnly_EB->Sumw2();
    // twoProngConversionRZMap_generalTracksOnly_EB->Sumw2();
    // twoProngConversionXYMap_generalTracksOnly_EE->Sumw2();
    // twoProngConversionRZMap_generalTracksOnly_EE->Sumw2();
    // twoProngConversionXYMap_generalTracksOnly_allEta->Sumw2();
    // twoProngConversionRZMap_generalTracksOnly_allEta->Sumw2();
