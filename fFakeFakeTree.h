...
// Wed Jul 27 15:34:58 2016 by ROOT version 6.02/13
// from TTree fFakeFakeTree/PhotonFakeFakeTree
// found on file: root://cmseos.fnal.gov//store/user/skaplan/noreplica/ExoDiPhotonNtuples/Data2016/DoubleEG/crab_DoubleEG_Run2016C_V2/160727_165956/0000/ExoDiPhotonAnalyzer_99.root
//////////////////////////////////////////////////////////

#ifndef fFakeFakeTree_h
#define fFakeFakeTree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fFakeFakeTree(TTree *tree=0);
   virtual ~fFakeFakeTree();
...
#ifdef fFakeFakeTree_cxx
fFakeFakeTree::fFakeFakeTree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmseos.fnal.gov//store/user/skaplan/noreplica/ExoDiPhotonNtuples/Data2016/DoubleEG/crab_DoubleEG_Run2016C_V2/160727_165956/0000/ExoDiPhotonAnalyzer_99.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmseos.fnal.gov//store/user/skaplan/noreplica/ExoDiPhotonNtuples/Data2016/DoubleEG/crab_DoubleEG_Run2016C_V2/160727_165956/0000/ExoDiPhotonAnalyzer_99.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://cmseos.fnal.gov//store/user/skaplan/noreplica/ExoDiPhotonNtuples/Data2016/DoubleEG/crab_DoubleEG_Run2016C_V2/160727_165956/0000/ExoDiPhotonAnalyzer_99.root:/diphotonAnalyzer");
      dir->GetObject("fFakeFakeTree",tree);

   }
   Init(tree);
}

fFakeFakeTree::~fFakeFakeTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fFakeFakeTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fFakeFakeTree::LoadTree(Long64_t entry)
{
...
void fFakeFakeTree::Init(TTree *tree)
{
...
void fFakeFakeTree::Show(Long64_t entry)
{
...
Int_t fFakeFakeTree::Cut(Long64_t entry)
{
